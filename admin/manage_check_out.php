...
<div class="container-fluid">
	<p class="mb-2"><b>Room : </b><?php echo isset($room['room']) ? $room['room'] : 'NA' ?></p>
	<p class="mb-2"><b>Room Category : </b><?php echo $cat['name'] ?></p>
	<p class="mb-2"><b>Room Price : </b><?php echo '₹'.number_format($cat['price'],2) ?></p>
	<p class="mb-2"><b>Reference no : </b><?php echo $ref_no ?></p>
	<p class="mb-2"><b>Checked In : </b><?php echo $name ?></p>
	<p class="mb-2"><b>Contact no : </b><?php echo $contact_no ?></p>
	<p class="mb-2"><b>Check-in Date/Time : </b><?php echo date("M d, Y h:i A",strtotime($date_in)) ?></p>
	<p class="mb-2"><b>Check-out Date/Time : </b><?php echo date("M d, Y h:i A",strtotime($date_out)) ?></p>
	<p class="mb-2"><b>Days : </b><?php echo $calc_days ?></p>
	<p class="mb-2"><b>Amount (Price * Days) : </b><?php echo '₹'.number_format($cat['price'] * $calc_days ,2) ?></p>
